...
namespace BackendU2W.Migrations
{
    ...
    [Migration("20230524152159_ComunidadPublicaYVisibleDB")]
    partial class ComunidadPublicaYVisibleDB
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BackendU2W.Models.Eventos", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            fechaFin = new DateTime(2023, 6, 24, 17, 21, 59, 233, DateTimeKind.Local).AddTicks(1592),
                            fechaInicio = new DateTime(2023, 5, 24, 17, 21, 59, 233, DateTimeKind.Local).AddTicks(1590),
                            id_com = 3,
                            titulo = "Evento1"
                        },
                        new
                        {
                            ...
                            fechaFin = new DateTime(2023, 6, 8, 17, 21, 59, 233, DateTimeKind.Local).AddTicks(1599),
                            fechaInicio = new DateTime(2023, 5, 24, 17, 21, 59, 233, DateTimeKind.Local).AddTicks(1597),
                            id_com = 2,
                            titulo = "Evento2"
                        },
                        new
                        {
                            id_evento = 3,
                            create_date = new DateTime(2023, 5, 24, 0, 0, 0, 0, DateTimeKind.Local),
                            fechaFin = new DateTime(2024, 5, 24, 17, 21, 59, 233, DateTimeKind.Local).AddTicks(1605),
                            fechaInicio = new DateTime(2023, 5, 24, 17, 21, 59, 233, DateTimeKind.Local).AddTicks(1604),
                            id_com = 2,
                            titulo = "Evento3"
                        },
                        new
                        {
                            ...
                            fechaFin = new DateTime(2023, 5, 29, 17, 21, 59, 233, DateTimeKind.Local).AddTicks(1611),
                            fechaInicio = new DateTime(2023, 5, 24, 17, 21, 59, 233, DateTimeKind.Local).AddTicks(1609),
                            id_com = 1,
                            titulo = "Evento4"
                        });
                });
