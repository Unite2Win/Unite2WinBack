...
namespace BackendU2W.Migrations
{
    ...
    [Migration("20230529015050_ActualizamosUsuariosAdminDb")]
    partial class ActualizamosUsuariosAdminDb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BackendU2W.Models.Comunidades", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id_com = 1,
                            clave = "12345",
                            create_date = new DateTime(2023, 5, 29, 0, 0, 0, 0, DateTimeKind.Local),
            ...
            modelBuilder.Entity("BackendU2W.Models.Eventos", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            fechaFin = new DateTime(2023, 6, 29, 3, 50, 50, 795, DateTimeKind.Local).AddTicks(4085),
                            fechaInicio = new DateTime(2023, 5, 29, 3, 50, 50, 795, DateTimeKind.Local).AddTicks(4083),
                            id_com = 3,
                            titulo = "Evento1"
                        },
                        new
                        {
                            ...
                            fechaFin = new DateTime(2023, 6, 13, 3, 50, 50, 795, DateTimeKind.Local).AddTicks(4091),
                            fechaInicio = new DateTime(2023, 5, 29, 3, 50, 50, 795, DateTimeKind.Local).AddTicks(4090),
                            id_com = 2,
                            titulo = "Evento2"
                        },
                        new
                        {
                            ...
                            asistentes = 0L,
                            create_date = new DateTime(2023, 5, 29, 0, 0, 0, 0, DateTimeKind.Local),
                            fechaFin = new DateTime(2024, 5, 29, 3, 50, 50, 795, DateTimeKind.Local).AddTicks(4097),
                            fechaInicio = new DateTime(2023, 5, 29, 3, 50, 50, 795, DateTimeKind.Local).AddTicks(4095),
                            id_com = 2,
                            titulo = "Evento3"
                        },
                        new
                        {
                            ...
                            fechaFin = new DateTime(2023, 6, 3, 3, 50, 50, 795, DateTimeKind.Local).AddTicks(4102),
                            fechaInicio = new DateTime(2023, 5, 29, 3, 50, 50, 795, DateTimeKind.Local).AddTicks(4101),
                            id_com = 1,
                            titulo = "Evento4"
                        });
                });
