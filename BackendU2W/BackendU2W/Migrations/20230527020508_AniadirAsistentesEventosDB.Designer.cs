...
namespace BackendU2W.Migrations
{
    ...
    [Migration("20230527020508_AniadirAsistentesEventosDB")]
    partial class AniadirAsistentesEventosDB
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BackendU2W.Models.Comunidades", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id_com = 1,
                            clave = "12345",
                            create_date = new DateTime(2023, 5, 27, 0, 0, 0, 0, DateTimeKind.Local),
            ...
            modelBuilder.Entity("BackendU2W.Models.Eventos", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            fechaFin = new DateTime(2023, 6, 27, 4, 5, 8, 665, DateTimeKind.Local).AddTicks(404),
                            fechaInicio = new DateTime(2023, 5, 27, 4, 5, 8, 665, DateTimeKind.Local).AddTicks(402),
                            id_com = 3,
                            titulo = "Evento1"
                        },
                        new
                        {
                            ...
                            fechaFin = new DateTime(2023, 6, 11, 4, 5, 8, 665, DateTimeKind.Local).AddTicks(410),
                            fechaInicio = new DateTime(2023, 5, 27, 4, 5, 8, 665, DateTimeKind.Local).AddTicks(408),
                            id_com = 2,
                            titulo = "Evento2"
                        },
                        new
                        {
                            ...
                            asistentes = 0L,
                            create_date = new DateTime(2023, 5, 27, 0, 0, 0, 0, DateTimeKind.Local),
                            fechaFin = new DateTime(2024, 5, 27, 4, 5, 8, 665, DateTimeKind.Local).AddTicks(416),
                            fechaInicio = new DateTime(2023, 5, 27, 4, 5, 8, 665, DateTimeKind.Local).AddTicks(415),
                            id_com = 2,
                            titulo = "Evento3"
                        },
                        new
                        {
                            ...
                            fechaFin = new DateTime(2023, 6, 1, 4, 5, 8, 665, DateTimeKind.Local).AddTicks(422),
                            fechaInicio = new DateTime(2023, 5, 27, 4, 5, 8, 665, DateTimeKind.Local).AddTicks(420),
                            id_com = 1,
                            titulo = "Evento4"
                        });
                });
