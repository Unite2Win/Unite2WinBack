...
namespace BackendU2W.Migrations
{
    ...
    [Migration("20230524022610_QuitamosUniqueComunidadesUsuariosDB")]
    partial class QuitamosUniqueComunidadesUsuariosDB
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BackendU2W.Models.Comunidades", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id_com = 1,
                            clave = "12345",
                            create_date = new DateTime(2023, 5, 24, 0, 0, 0, 0, DateTimeKind.Local),
            ...
            modelBuilder.Entity("BackendU2W.Models.Eventos", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            fechaFin = new DateTime(2023, 6, 24, 4, 26, 10, 216, DateTimeKind.Local).AddTicks(6334),
                            fechaInicio = new DateTime(2023, 5, 24, 4, 26, 10, 216, DateTimeKind.Local).AddTicks(6332),
                            id_com = 3,
                            titulo = "Evento1"
                        },
                        new
                        {
                            ...
                            fechaFin = new DateTime(2023, 6, 8, 4, 26, 10, 216, DateTimeKind.Local).AddTicks(6341),
                            fechaInicio = new DateTime(2023, 5, 24, 4, 26, 10, 216, DateTimeKind.Local).AddTicks(6339),
                            id_com = 2,
                            titulo = "Evento2"
                        },
                        new
                        {
                            id_evento = 3,
                            create_date = new DateTime(2023, 5, 24, 0, 0, 0, 0, DateTimeKind.Local),
                            fechaFin = new DateTime(2024, 5, 24, 4, 26, 10, 216, DateTimeKind.Local).AddTicks(6347),
                            fechaInicio = new DateTime(2023, 5, 24, 4, 26, 10, 216, DateTimeKind.Local).AddTicks(6345),
                            id_com = 2,
                            titulo = "Evento3"
                        },
                        new
                        {
                            ...
                            fechaFin = new DateTime(2023, 5, 29, 4, 26, 10, 216, DateTimeKind.Local).AddTicks(6352),
                            fechaInicio = new DateTime(2023, 5, 24, 4, 26, 10, 216, DateTimeKind.Local).AddTicks(6351),
                            id_com = 1,
                            titulo = "Evento4"
                        });
                });
