...
namespace BackendU2W.Migrations
{
    ...
    [Migration("20230522192436_CambioPlanesAEventosDB")]
    partial class CambioPlanesAEventosDB
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BackendU2W.Models.Eventos", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            fechaFin = new DateTime(2023, 6, 22, 21, 24, 36, 720, DateTimeKind.Local).AddTicks(1634),
                            fechaInicio = new DateTime(2023, 5, 22, 21, 24, 36, 720, DateTimeKind.Local).AddTicks(1632),
                            id_com = 3,
                            titulo = "Evento1"
                        },
                        new
                        {
                            ...
                            fechaFin = new DateTime(2023, 6, 6, 21, 24, 36, 720, DateTimeKind.Local).AddTicks(1641),
                            fechaInicio = new DateTime(2023, 5, 22, 21, 24, 36, 720, DateTimeKind.Local).AddTicks(1639),
                            id_com = 2,
                            titulo = "Evento2"
                        },
                        new
                        {
                            id_evento = 3,
                            create_date = new DateTime(2023, 5, 22, 0, 0, 0, 0, DateTimeKind.Local),
                            fechaFin = new DateTime(2024, 5, 22, 21, 24, 36, 720, DateTimeKind.Local).AddTicks(1647),
                            fechaInicio = new DateTime(2023, 5, 22, 21, 24, 36, 720, DateTimeKind.Local).AddTicks(1646),
                            id_com = 2,
                            titulo = "Evento3"
                        },
                        new
                        {
                            ...
                            fechaFin = new DateTime(2023, 5, 27, 21, 24, 36, 720, DateTimeKind.Local).AddTicks(1653),
                            fechaInicio = new DateTime(2023, 5, 22, 21, 24, 36, 720, DateTimeKind.Local).AddTicks(1651),
                            id_com = 1,
                            titulo = "Evento4"
                        });
                });
