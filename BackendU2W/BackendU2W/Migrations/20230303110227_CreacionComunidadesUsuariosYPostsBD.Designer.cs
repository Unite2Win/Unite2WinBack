...
namespace BackendU2W.Migrations
{
    ...
    [Migration("20230303110227_CreacionComunidadesUsuariosYPostsBD")]
    partial class CreacionComunidadesUsuariosYPostsBD
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BackendU2W.Models.Comunidades", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            banner = "banner1",
                            clave = "12345",
                            create_date = new DateTime(2023, 3, 3, 0, 0, 0, 0, DateTimeKind.Local),
            ...
            modelBuilder.Entity("BackendU2W.Models.ComunidadesUsuarios", b =>
                {
                    ...
                    b.HasKey("id_com_usu", "id_com", "id_usu");

                    b.HasIndex("id_com");

                    b.HasIndex("id_usu");

                    b.ToTable("ComunidadesUsuarios", (string)null);
